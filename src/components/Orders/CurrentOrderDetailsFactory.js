...
const CurrentOrderDetailsFactory = () => {
    return <>  
    <NavBarBlue />
...
وسوستة مزين برسومات</p>
 ...
 <div style={{display:'flex',margin:'10px 15px', textAlign:'center', alignItems:'center', justifyContent:'center'}}> 
 <div style={{border:' 2px solid #7EA91A61', borderRadius:'15px', padding:'5px 20px 8px 20px', color:'#7A808A',
 fontWeight:'bold', background:'#7EA91A33'}}>
 جاري التوصيل </div>
 </div>
...
export default CurrentOrderDetailsFactory;
...
const FinshedOrderDetalisFactory2 = () => {
    return <>  
    <NavBarBlue />
...
<div style={{display:'flex', textAlign:'center', alignItems:'center', justifyContent:'center'}}> 
    <div style={{border: "1.85px solid #FFB80130", borderRadius:'12px', color:'#F4861C', 
    fontWeight:'bold',  display:'flex', background:'#FFB80130', padding:'2px 10px'}}> <div> <img src={rating} style={{paddingLeft:'5px'}}  /> </div> 
   تقييم الطلب</div>
 </div>
...
وسوستة مزين برسومات</p>
 ...
 <div><img src={reorderImg}/></div>
  ...
  <div style={{display:'flex', fontSize:'20px', marginTop:'-10px', justifyContent:'center', alignItems:'center'}}>
    <div><img src={dif} style={{paddingLeft:'2px', marginTop:'-15px'}}  /></div>
        <p style={{color:'#7EA91A', fontSize:'16px'}}>  عينات مختلفة</p>
    </div>
...
export default FinshedOrderDetalisFactory2;
...
import profileStore from '../../images/profileF2.png'
...
const FinishedOrderDetailsFactory = () => {
...
<div style={{display:'flex' , justifyContent:'center',flexDirection:'column' , padding:'8px' }} >
  <p style={{fontSize:'19px', color:'#220E5F', textAlign:'start', fontWeight:'bold'}}>  المصنع</p>
  <p style={{fontSize:'17px', color:'#636270', textAlign:'start', marginTop:'-15px'}}>  مصنع النور</p>
...
<div style={{display:'flex', textAlign:'center', alignItems:'center', justifyContent:'center'}}> 
    ...
    fontWeight:'bold',  display:'flex', background:'#FFB80130', padding:'2px 10px' , cursor:'pointer'}}>
     <div> <img src={rating} style={{paddingLeft:'5px'}}  /> </div> 
   تقييم الطلب</div>
 </div>
 ...
 <Modal show={show} onHide={handleClose}  >
    ...
    <div style={{display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column'}}> 
       <div><img src={ProfileFac2} /></div>
       <p style={{color:'#051427', fontSize:'17px', fontWeight:'bold'}}> مصنع النور</p>
     
     </div>

    <div style={{border:' 1.69px solid #ECECEC', borderRadius:'12px', display:'flex', justifyContent:'space-between', padding:'3px 10px'}} >
     <p style={{color:'#051427', fontSize:'17px', fontWeight:'500'}}> قييم المصنع</p>
...
المساحة، لقد تم توليد هذا النص. " 
    ...
    <div style={{display:'flex', justifyContent:'center', alignItems:'center'}}> 
       ...
       <div><img src={wear} width='50px' height='62px' style={{marginTop:'-20px', marginLeft:'10px'}}  /></div>
       <div style={{display:'flex', flexDirection:'column'}}>  
       <p style={{width:'70%', color:'#220E5F', fontSize:'15px'}}> سويت شيرت بغطاء للرأس
...
وسوستة مزين برسومات</p>
 ...
 <div><img src={reorderImg}/></div>
    ...
    <div style={{background:'#F4F5F7' , borderRadius:'20px', padding:'20px', marginTop:'15px'}}>
 ...
 <div style={{display:'flex' , justifyContent:'center',flexDirection:'column' , padding:'8px' }} >
   <p style={{fontSize:'19px', color:'#220E5F', textAlign:'start', fontWeight:'bold'}}>  المصنع</p>
   <p style={{fontSize:'17px', color:'#636270', textAlign:'start', marginTop:'-15px'}}>  مصنع تبارك   </p>
...
export default FinishedOrderDetailsFactory;
...
import iconStore from '../../images/storecolor.png'
import iconFactory from '../../images/factoreyicon.png'
      ...
      <Row className="m-3">
        ...
        <Link to='/store-partner' style={{textDecoration:'none'}}>
         <div style={{border :'none' , borderRadius:'15px' , width:'178px' , height:'33.74px' , 
            ...
            <h6 style={{color:'#636270' , paddingTop:'4px'}}>متجر </h6>
          </div>
          </Link>
        </Col>
        ...
        <div style={{border :'2px solid rgba(232, 232, 232, 1)' , borderRadius:'23px' , width:'178px' , height:'33.74px' , 
            ...
            , alignItems:'center', gap:'10px' }}>
              ...
              <MdFactory style={{color:'#FFFFFF', fontSize:'20px'}} />
          
                <h6 style={{  color:'#FFFFFF' , fontSize:'15px', marginTop:'5px' }}>مصنع  </h6>
    ...
    <Container>
      <Row>
        ...
        <form class="form-floating ">
          <input type="email" class="form-control" id="floatingInputValue" placeholder="اسم المصنع" value="مصنع تبارك " 
           style={{borderRadius:'15px', color: "#585858" , paddingRight:'20px'}}/>
          <label for="floatingInputValue" style={{color:'#585858', fontWeight:'bold'}} >  اسم المصنع</label>
        </form>
  ...
  <div class="col-md">
    <div class="form-floating">
      ...
      <label for="floatingSelectGrid">المنطقه  </label>
        ...
        <form class="form-floating ">
          <input type="text" class="form-control" id="floatingInputValue" placeholder="رابط المصنع" value="https//www.website.com " 
           style={{borderRadius:'15px', color: "#220E5F" , paddingRight:'20px'}}/>
          <label for="floatingInputValue" style={{color:'#585858', fontWeight:'bold'}} >  رابط المصنع</label>
        </form>
...
<div style={{display:'flex', gap:'10px'}}>
    ...
    <Link to='/factory-wallet' style={{textDecoration:'none', color:'#220E5F'}}>
  ...
  <div class="col-md">
    <div class="form-floating">
       ...
       <input type="Date" class="form-control" id="floatingInputValue" placeholder="cvv  " value=" 06/26 " 
           style={{borderRadius:'15px', color: "#585858" , paddingRight:'20px'}}/>
